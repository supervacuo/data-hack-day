...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResponseObject.event'
        db.add_column('central_responseobject', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['central.Event']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ResponseObject.event'
        db.delete_column('central_responseobject', 'event_id')
