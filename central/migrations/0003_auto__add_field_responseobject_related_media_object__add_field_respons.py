...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ResponseObject.reply_to'
        db.add_column('central_responseobject', 'reply_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['central.ResponseObject'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ResponseObject.reply_to'
        db.delete_column('central_responseobject', 'reply_to_id')
    ...
    models = {
        ...
        'central.responseobject': {
            ...
            'related_media_object': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['central.MediaObject']", 'null': 'True', 'blank': 'True'}),
