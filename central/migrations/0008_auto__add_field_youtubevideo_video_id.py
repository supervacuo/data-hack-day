...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'YouTubeVideo.video_id'
        db.add_column('central_youtubevideo', 'video_id',
                      self.gf('django.db.models.fields.CharField')(max_length=11, null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'YouTubeVideo.video_id'
        db.delete_column('central_youtubevideo', 'video_id')
